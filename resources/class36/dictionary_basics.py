...
def create_dictionary_v2():
    ...
    # all desired data.
    enrollments = {'COMP130': 23, 'COMP232': 18}
    return enrollments
...
def is_known(course):
    ...
    enrollments = create_dictionary_v1()
    # challenge 4: Fix the following line of code - change "if True" to the correct
    # expression
    if True:
        return True
    else:
